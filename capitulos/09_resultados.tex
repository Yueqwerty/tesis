...
\begin{table}[htbp]
    ...
    \begin{tabular}{@{}llrrr@{}}
        ...
        \midrule
        Status Quo (431 TM) & Corta (7 días)   & 100,00 & 0,01 & 0,03 \\
        Status Quo (431 TM) & Media (14 días)  & 99,55 & 0,55 & 2,00 \\
        Status Quo (431 TM) & Larga (21 días)  & 98,10 & 2,12 & 7,73 \\
        \addlinespace
        Propuesta (681 TM)  & Corta (7 días)   & 100,00 & 0,00 & 0,00 \\
        Propuesta (681 TM)  & Media (14 días)  & 99,96 & 0,04 & 0,13 \\
        Propuesta (681 TM)  & Larga (21 días)  & 99,43 & 0,62 & 2,27 \\
        \bottomrule
    \end{tabular}
\end{table}
...
\textbf{Resultados:}
\begin{itemize}
    \item Nivel de Servicio Promedio (Propuesta): 99,80\%
    \item Nivel de Servicio Promedio (Status Quo): 99,22\%
    \item \textbf{Efecto Endógeno: +0,58 puntos porcentuales}
\end{itemize}
...
\textbf{Resultados:}
\begin{itemize}
    \item Nivel de Servicio Promedio (Corta): 100,00\%
    \item Nivel de Servicio Promedio (Larga): 98,77\%
    \item \textbf{Efecto Exógeno: +1,23 puntos porcentuales}
\end{itemize}
...
\begin{equation}
\text{Ratio de Sensibilidad} = \frac{\text{Efecto Exógeno}}{\text{Efecto Endógeno}} = \frac{1,23\%}{0,58\%} = 2,12
\end{equation}

\textbf{Interpretación:} La resiliencia del sistema de suministro de GLP de
Aysén es \textbf{2,12 veces más sensible} a la duración de las disrupciones
...
0,58 puntos porcentuales. Sin embargo, incrementar la duración máxima de
disrupciones de 7 a 21 días degrada el nivel de servicio en 1,23 puntos
porcentuales. El ratio 2,12 indica que el sistema es aproximadamente el doble
